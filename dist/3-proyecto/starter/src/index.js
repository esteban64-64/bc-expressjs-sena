...
// ─── Calcular resumen ───
function calcularResumen(apprentices) {
...
function filtrarPorCategoria(apprentices, category) {
...
function mostrarResumen(resumen, filtro) {
...
async function generarReporte(resumen, filtrados, filtro) {
    const reporte = {
